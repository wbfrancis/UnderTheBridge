...
|---|---|---|---|---|
| CHAR-001 | `Bartender.png` | 64x64 RGBA, one pose; SHA-256 `8539FC5D9261114266EA371F595653AA5A9B16B8102EE69BDF4242D3E63D232F` | Reference/temporary | Ticket #2 validated 0.05 m/px, nearest filtering, alpha discard, and fixed-Y billboard; do not treat it as production animation art. |
